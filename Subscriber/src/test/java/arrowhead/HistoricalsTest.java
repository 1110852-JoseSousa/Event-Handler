...
public class HistoricalsTest {
	...
	public void testHistoricals() throws Exception {
			System.out.println("Running Historicals Test");
			response = target.path("historicals").path(this.UID).request(MediaType.APPLICATION_XML).post(Entity.entity(r, MediaType.APPLICATION_XML));
